/// Centralized error handling for the StakCast prediction market contract
/// All error messages are defined here to avoid duplication and ensure consistency
...
pub mod Errors {
    ...
    pub const REENTRANCY_DETECTED: felt252 = 'Reentrant call';
    ...
    pub const MARKET_NOT_EXIST: felt252 = 'Market does not exist';
    pub const MARKET_NOT_RESOLVED: felt252 = 'Market is not resolved';
    pub const MARKET_NOT_ENDED: felt252 = 'Market not yet ended';
    pub const MARKET_RESOLVED: felt252 = 'Market resolved';

    // Time validation errors
    pub const END_TIME_FUTURE: felt252 = 'End time must be in future';
    pub const DURATION_TOO_SHORT: felt252 = 'Market duration too short';
    pub const DURATION_TOO_LONG: felt252 = 'Market duration too long';
    ...
    pub const MIN_AMOUNT_POSITIVE: felt252 = 'Min amount must be positive';
    pub const MAX_GREATER_THAN_MIN: felt252 = 'Max must be greater than min';
    ...
    // Market type validation errors
    pub const INVALID_MARKET_TYPE: felt252 = 'Invalid market type';
    pub const INVALID_MARKET_TYPE_EXCLAMATION: felt252 = 'Invalid market type!';

    // User stake errors
    pub const ALREADY_CLAIMED: felt252 = 'Already claimed';
    pub const NO_WINNING_STAKE: felt252 = 'No winning stake for user';

    // Configuration errors
    pub const MIN_DURATION_POSITIVE: felt252 = 'Min duration must be positive';
    pub const RESOLUTION_WINDOW_POSITIVE: felt252 = 'Resolution window positive';
    pub const FEE_EXCEEDS_MAXIMUM: felt252 = 'Fee cannot exceed 10%';
