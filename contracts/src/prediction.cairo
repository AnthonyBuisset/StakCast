...
pub mod PredictionHub {
    ...
    impl SecurityImpl of SecurityTrait {
        ...
        fn assert_valid_market_timing(self: @ContractState, end_time: u64) {
            ...
            assert(end_time > current_time, Errors::END_TIME_FUTURE);

            let duration = end_time - current_time;

            assert(duration >= min_duration, Errors::DURATION_TOO_SHORT);

            assert(duration <= max_duration, Errors::DURATION_TOO_LONG);
        }
        ...
        fn assert_valid_amount(self: @ContractState, amount: u256) {
            assert(amount > 0, Errors::AMOUNT_POSITIVE);
    ...
    impl PredictionHubImpl of IPredictionHub<ContractState> {
        ...
        fn get_all_predictions_by_market_category(
            ...
            assert(category <= 7, Errors::INVALID_MARKET_TYPE_EXCLAMATION);
        ...
        fn claim(ref self: ContractState, market_id: u256) {
            ...
            assert(user_amount_on_option_winning > 0, Errors::NO_WINNING_STAKE);
        ...
        fn resolve_prediction(ref self: ContractState, market_id: u256, winning_choice: u8) {
            ...
            assert(current_time >= market.end_time, Errors::MARKET_NOT_ENDED);
    ...
    impl AdditionalAdminImpl of IAdditionalAdmin<ContractState> {
        ...
        fn set_time_restrictions(
            ...
            assert(min_duration > 0, Errors::MIN_DURATION_POSITIVE);

            assert(max_duration > min_duration, Errors::MAX_GREATER_THAN_MIN);
        ...
        fn set_platform_fee(ref self: ContractState, fee_percentage: u256) {
            ...
            assert(fee_percentage <= 1000, Errors::FEE_EXCEEDS_MAXIMUM); // 1000 basis points = 10%
        ...
        fn set_protocol_restrictions(ref self: ContractState, min_amount: u256, max_amount: u256) {
            ...
            assert(min_amount > 0, Errors::MIN_AMOUNT_POSITIVE);

            assert(max_amount > min_amount, Errors::MAX_GREATER_THAN_MIN);
